...
export function MyKitchenScreen() {
  ...
  const inStockCount = countKitchenItemsInStock(kitchenInventory);
  const groupedItems = useMemo(() => groupKitchenItemsByCategory(kitchenInventory), [kitchenInventory]);
  ...
  function closeAddModal() {
    ...
    setDraftName('');
    setDraftCount('1');
    setDraftCategory(KITCHEN_CATEGORIES[0]);
  }
        ...
        <View style={styles.content}>
          ...
          {isLoading ? (
            <View style={styles.loadingCard}>
              ...
              <Text style={styles.loadingText}>Checking what is already stocked in your kitchen...</Text>
            </View>
          ) : (
